...
1. **Инициализация** - создание объекта Money с начальными значениями
2. **Главное меню** - предоставляет доступ к тестированию всех функций:
   - Тестирование задания 6 (конструкторы и метод AddKopeks)
   - Тестирование задания 7 (перегруженные операции)
   - Изменение текущей суммы
   - Просмотр информации о текущем объекте
3. **Валидация ввода** - защита от некорректных данных пользователя
4. **Обработка исключений** - корректная обработка ошибок переполнения и невалидных значений
